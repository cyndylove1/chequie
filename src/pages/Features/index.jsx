  ...
  return (
    <div className="px-4">
      <div className=" text-center">
        <h2 className="text-[15px] text-grey fw-thin pt-[8rem]">FEATURES</h2>
        <h2 className="pt-4 lg:text-[40px] md:text-[25px] text-[20px]">
      ...
      <div className="flex items-center md:flex-row flex-col justify-center md:gap-[58px] gap-[20px] pt-[5rem] md:px-6 lg:px-0">
        ...
        <div className="w-full lg:w-[40%] text-center md:text-left">
          <h2 className="text-[#0052C4] lg:text-[30px] text-[25px] fw-medium py-2">
            Save with your Ajo Squad. <br /> Packing guaranteed!
          </h2>
      ...
      <div className="flex items-center md:flex-row flex-col-reverse justify-center md:gap-[58px] gap-[20px] md:pt-0 lg:mt-[5rem] md:px-6 lg:px-0">
        <div className="w-full lg:w-[40%] text-center md:text-left">
          ...
          <h5 className="md:pb-0 pb-10">
            ...
            towards achieving a goal or just because you have too much to cash,
            get attractive interest rates on the Chequemate app.
          </h5>
        </div>
        <div className="">
      ...
      <div className="flex items-center justify-center md:gap-[58px] gap-[20px] lg:pt-[5rem] md:flex-row flex-col md:px-6 lg:px-6">
        ...
        <div className="w-full lg:w-[40%] text-center md:text-left">
          ...
          <h5>
            Secure your savings by locking funds for a set period and build
            strong saving habits and achieving your financial goals with the
            support of a trusted community, all within the Chequemate app.
          </h5>
        </div>
      </div>
      <Access />
