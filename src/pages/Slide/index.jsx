...
import chekee from "../../assets/images/Frame 1000004252.png";
...
const Slide = () => {
  ...
  const settings = {
    ...
    responsive: [
      ...
      {
        breakpoint: 768, // Small screens (up to 768px)
        settings: {
          slidesToShow: 1,
        },
      },
  ...
  return (
    <div className="">
      <div className="carousel-container lg:pt-[15rem] pt-[10rem] ">
