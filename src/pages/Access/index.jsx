...
const Access = () =>{
    return(
        <div>
            <div>
                <h2 className="text-[15px] text-grey fw-thin lg:pt-[8rem] pt-[5rem] text-center">EARLY ACCESS</h2>
                <div className="flex items-center justify-center gap-[3rem] lg:pt-[4rem] pt-[2rem] md:flex-row flex-col  ">
                    ...
                    <div className="text-center md:text-left w-full lg:w-[40%]">
                        <h2 className="lg:text-[48px] text-[26px]">Hi,<span className="text-green"> I’m Chequie</span></h2>
                        <div className="">
